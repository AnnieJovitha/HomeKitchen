 ...
 const helloFreshImageURL = `https://img.hellofresh.com/hellofresh_s3`;
  ...
  return (
    <div className={styles.background + " max-w-sm rounded overflow-hidden shadow-lg"}>
        <input id="vue-checkbox" onClick={onSelected} type="checkbox" value="" className={styles.checkBox +  " mt-6 ml-6 mb-6 w-5 h-5 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"}/>
